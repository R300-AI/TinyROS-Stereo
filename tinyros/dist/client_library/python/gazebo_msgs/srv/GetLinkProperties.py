...
class GetLinkPropertiesRequest(tinyros.Message):
    __slots__ = ['__id__','link_name']
    _slot_types = ['uint32','string']

    def __init__(self):
        super(GetLinkPropertiesRequest, self).__init__()
        self.__id__ = 0
        self.link_name = ''
    ...
    def getMD5(self):
        return "30b187ce76c283d51c190e8f7d59f0ff"
...
class GetLinkPropertiesResponse(tinyros.Message):
    __slots__ = ['__id__','com','gravity_mode','mass','ixx','ixy','ixz','iyy','iyz','izz','success','status_message']
    _slot_types = ['uint32','geometry_msgs.msg.Pose','bool','float64','float64','float64','float64','float64','float64','float64','bool','string']

    def __init__(self):
        super(GetLinkPropertiesResponse, self).__init__()
        self.__id__ = 0
    ...
    def getMD5(self):
        return "d45a9e2f72bfb95f519b2d0cbaac4512"
