...
static const char GETPLAN[] = "nav_msgs/GetPlan";
  ...
  class GetPlanRequest : public tinyros::Msg
  {
    ...
    virtual tinyros::string getType(){ return GETPLAN; }
    virtual tinyros::string getMD5(){ return "557d5ea947f7761284cf7abef1cd7227"; }
  ...
  class GetPlanResponse : public tinyros::Msg
  {
    ...
    virtual tinyros::string getType(){ return GETPLAN; }
    virtual tinyros::string getMD5(){ return "67c62b8c931eabfe35c88aed4b8f1258"; }
    uint32_t getID() const { return this->__id__; }
    void setID(uint32_t id){ this->__id__ = id; }
