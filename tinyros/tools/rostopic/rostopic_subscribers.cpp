...
static std::map<std::string, tinyros::Subscriber_*> rostopic_subscribers = {
    ...
    {"tf2_msgs/LookupTransformResult", new EchoSubscriber<tinyros::tf2_msgs::LookupTransformResult>()},
    {"tf2_msgs/TF2Error", new EchoSubscriber<tinyros::tf2_msgs::TF2Error>()},
    {"tf2_msgs/LookupTransformActionResult", new EchoSubscriber<tinyros::tf2_msgs::LookupTransformActionResult>()},
    {"tf2_msgs/TFMessage", new EchoSubscriber<tinyros::tf2_msgs::TFMessage>()},
    {"tf2_msgs/LookupTransformActionGoal", new EchoSubscriber<tinyros::tf2_msgs::LookupTransformActionGoal>()},
    {"tf2_msgs/LookupTransformFeedback", new EchoSubscriber<tinyros::tf2_msgs::LookupTransformFeedback>()},
    {"tf2_msgs/LookupTransformGoal", new EchoSubscriber<tinyros::tf2_msgs::LookupTransformGoal>()},
    {"tf2_msgs/LookupTransformAction", new EchoSubscriber<tinyros::tf2_msgs::LookupTransformAction>()},
    {"tf2_msgs/LookupTransformActionFeedback", new EchoSubscriber<tinyros::tf2_msgs::LookupTransformActionFeedback>()},
